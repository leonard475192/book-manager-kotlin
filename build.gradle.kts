...
dependencies {
	...
	testImplementation("org.junit.jupiter:junit-jupiter-engine:5.7.1") // 追加
	testImplementation("org.assertj:assertj-core:3.19.0") // 追加
	testImplementation("org.mockito:mockito-core:3.8.0") // 追加
	testImplementation("com.nhaarman.mockitokotlin2:mockito-kotlin:2.2.0") // 追加
}
